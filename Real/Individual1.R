...
model_data = modelField$real$individual1$model_data
field_data = modelField$real$individual1$field_data
pred_data = modelField$real$individual1$pred_data
...
saveRDS(real_dat_results, "BrachialRes1.rds")
