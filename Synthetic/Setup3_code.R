...
# model_data = modelField$synthetic$setup3$model_data
# field_data = modelField$synthetic$setup3$field_data

modelField = readRDS("modelField_data.rds") # model and field data 
model_data = modelField$synthetic$setup3$model_data # model data from lhs 
field_data = modelField$synthetic$setup3$field_data # observed data with 3 replicates
pred_data  = modelField$synthetic$setup3$pred_data # prediction data 
true_par = modelField$synthetic$setup3$true # true parameter values
...
true_par = modelField$synthetic$setup3$true

model3 = list(stage1 = stage1, stage2 = stage2, nsamples = nsamples, 
