...
model_data = modelField$synthetic$setup1$model_data # model data from lhs 
field_data = modelField$synthetic$setup1$field_data # observed data with 3 replicates
pred_data  = modelField$synthetic$setup1$pred_data # prediction data 
true_par = modelField$synthetic$setup1$true # true parameter values
...
#true_par = modelField$synthetic$setup1$true

model1 = list(stage1 = stage1, stage2 = stage2, nsamples = nsamples, 
